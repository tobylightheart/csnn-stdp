%% run_lif_sim_batches_addSTDP.m
% Batch simulation of leaky integrate-and-fire neurons with additive STDP
% close all;
% clearvars;
% clc;

if ~isdir('lif_sim_data_addSTDP')
	mkdir('lif_sim_data_addSTDP')
end
...
for r_b = r_b_list
  ...
  %   rng(rng_states_sim{sim_num});  
    ...
    file_name = ...
      fullfile('lif_sim_data_addSTDP', ...
        ['lif_sim_addSTDP_rb', num2str(r_b, '%02d'), ...
